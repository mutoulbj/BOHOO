...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('notification', 'status',
                      self.gf('django.db.models.fields.CharField')(default='unread', max_length=128, db_index=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('notification', 'status')
