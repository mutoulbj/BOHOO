...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('no_type', self.gf('django.db.models.fields.CharField')(max_length=128, db_index=True)),
            ('group_action', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('topic_action', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('friend_action', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notify_user', to=orm['User.MyUser'])),
            ('topic', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notify_topic', null=True, to=orm['groups.Topic'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notify_group', null=True, to=orm['groups.Group'])),
            ('reply', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notify_reply', null=True, to=orm['groups.Reply'])),
        ))
        db.send_create_signal(u'sys_notification', ['Notification'])


    def backwards(self, orm):
        # Deleting model 'Notification'
        db.delete_table('notification')
