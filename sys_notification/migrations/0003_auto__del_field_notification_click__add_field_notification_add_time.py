...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notification.click'
        db.delete_column('notification', 'click')

        # Adding field 'Notification.add_time'
        db.add_column('notification', 'add_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 20, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Notification.click'
        db.add_column('notification', 'click',
                      self.gf('django.db.models.fields.CharField')(default='unclick', max_length=128, db_index=True),
                      keep_default=False)

        # Deleting field 'Notification.add_time'
        db.delete_column('notification', 'add_time')
