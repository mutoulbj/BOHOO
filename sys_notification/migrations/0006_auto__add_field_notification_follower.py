...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('notification', 'follower',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notify_follower', null=True, to=orm['User.MyUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.follower'
        db.delete_column('notification', 'follower_id')
    ...
    models = {
        ...
        u'groups.group': {
            ...
            'gfriend': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['groups.Group']", 'null': 'True', 'blank': 'True'}),
            ...
            'member': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['User.MyUser']", 'null': 'True', 'blank': 'True'}),
        ...
        u'sys_notification.notification': {
            ...
            'follower': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'notify_follower'", 'null': 'True', 'to': u"orm['User.MyUser']"}),
