...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.joint_type'
        db.add_column('applicant', 'joint_type',
                      self.gf('django.db.models.fields.CharField')(default='member', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.joint_type'
        db.delete_column('applicant', 'joint_type')
    ...
    models = {
        ...
        u'groups.applicant': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joint_type': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
