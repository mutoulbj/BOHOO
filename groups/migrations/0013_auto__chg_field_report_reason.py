...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.reason'
        db.alter_column('report', 'reason', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Report.reason'
        db.alter_column('report', 'reason', self.gf('django.db.models.fields.SmallIntegerField')())
