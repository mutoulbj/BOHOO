...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.report_type'
        db.alter_column('report', 'report_type', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Report.report_type'
        db.alter_column('report', 'report_type', self.gf('django.db.models.fields.SmallIntegerField')())
    ...
    models = {
        ...
        u'groups.report': {
            ...
            'report_type': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
