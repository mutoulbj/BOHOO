...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.topic'
        db.alter_column('report', 'topic_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['groups.Topic']))

        # Changing field 'Report.reply'
        db.alter_column('report', 'reply_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['groups.Reply']))

    def backwards(self, orm):

        # Changing field 'Report.topic'
        db.alter_column('report', 'topic_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['groups.Topic']))

        # Changing field 'Report.reply'
        db.alter_column('report', 'reply_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['groups.Reply']))
    ...
    models = {
        ...
        u'groups.report': {
            ...
            'reply': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'reply_report'", 'null': 'True', 'to': u"orm['groups.Reply']"}),
            'report_type': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'topic_report'", 'null': 'True', 'to': u"orm['groups.Topic']"}),
