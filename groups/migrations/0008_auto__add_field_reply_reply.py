...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('reply', 'reply',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reply_reply', null=True, to=orm['groups.Reply']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reply.reply'
        db.delete_column('reply', 'reply_id')
