...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('applicant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('applicant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='applicant_user', to=orm['User.MyUser'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='apply_group', to=orm['groups.Group'])),
            ('reason', self.gf('django.db.models.fields.TextField')()),
            ('status', self.gf('django.db.models.fields.CharField')(default='processing', max_length=256)),
        ))
        db.send_create_signal(u'groups', ['Applicant'])


    def backwards(self, orm):
        # Deleting model 'Applicant'
        db.delete_table('applicant')
