...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.reply'
        db.add_column('report', 'reply',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='reply_report', to=orm['groups.Reply']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.reply'
        db.delete_column('report', 'reply_id')
    ...
    models = {
        ...
        u'groups.report': {
            ...
            'reply': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reply_report'", 'to': u"orm['groups.Reply']"}),
