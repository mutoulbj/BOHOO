...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('topic', 'status',
                      self.gf('django.db.models.fields.CharField')(default='enabled', max_length=56),
                      keep_default=False)

        # Adding field 'Reply.status'
        db.add_column('reply', 'status',
                      self.gf('django.db.models.fields.CharField')(default='enabled', max_length=56),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('topic', 'status')

        # Deleting field 'Reply.status'
        db.delete_column('reply', 'status')
